package org.Prison.Main.net.amoebaman.util;
...
public final class Reflection {
	...
	public synchronized static Class<?> getNMSClass(String className) {
		...
		Class<?> clazz = null;
		if (className.equals("IChatBaseComponent$ChatSerializer") || className.equals("ChatSerializer")){
			clazz = net.minecraft.server.v1_8_R3.IChatBaseComponent.ChatSerializer.class;
		}else{
		try {
