...
public class SmartTrait {
	...
	public static int getLevel(Player p){
		if (Files.config().contains("Players." + p.getName() + ".Smartlvl")){
			return Files.config().getInt("Players." + p.getName() + ".Smartlvl");
		}else{
			return 0;
		}
	}
	...
	public static int getSmart(Player p){
		if (Files.config().contains("Players." + p.getName() + ".Smart")){
			return Files.config().getInt("Players." + p.getName() + ".Smart");
		}else{
			return 0;
		}
	}
	...
	public static void levelUp(Player p){
		...
		if (currentlvl < 15){
			...
			Files.config().set("Players." + p.getName() + ".Smartlvl", newlvl);
			Files.config().set("Players." + p.getName() + ".Smart", 0);
